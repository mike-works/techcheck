...
powershell -Command "(New-Object Net.WebClient).DownloadFile('https://mikeworks-libs.s3.amazonaws.com/techcheck/index.js?v=%RANDOM%%RANDOM%', '%TECHCHECK_TMP_FOLDER%/index.js')"
